...
import { getProfile, getSkills } from '../services/supabaseService';
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        console.error("Failed to fetch about page data:", (error as Error).message);
      } finally {
        setLoading(false);
      }
    };
    ...
    <div className="space-y-12">
      ...
      <div className="grid md:grid-cols-3 gap-8 items-start">
        <div className="md:col-span-1 flex justify-center">
            <img 
                src={getOptimizedCloudinaryUrl(profile?.avatarUrl || "https://picsum.photos/seed/aboutvideo/400/500")}
                alt="About me" 
        ...
        <div className="md:col-span-2 space-y-4 text-gray-300">
          ...
          <p className="whitespace-pre-wrap">
           ...
           <a
            href="/path-to-your-cv.pdf" // This can be a URL from Supabase in the future
            download
